 ...
 * with -40째C<T<+105째C its Min: 1.18V, Typ 1.21V, Max: 1.24V
 */
#define VREFINT 121
/*
...
static const ADCConversionGroup adcgrpcfg1 = {
  ...
  0,                                        /* CR1 */
  ADC_CR2_SWSTART,                          /* CR2 */
  ADC_SMPR1_SMP_AN12(ADC_SAMPLE_3),         //sample times ch10-18
  ...
  ADC_SQR3_SQ1_N(ADC_CHANNEL_IN12)          //SQR3: Conversion group sequence 1...6
};
...
void cmd_measureDirect(BaseSequentialStream *chp, int argc, char *argv[]) {
  ...
  *   25째C === 0.76V
  * Thus:
  *  temp [째C] = (temp[V]-0,76 [V])/0,0025 [V/째C] +25 [째C]
  */
...
static const ADCConversionGroup adcgrpcfg2 = {
  ...
  0,                        /* CR1 */
  ADC_CR2_SWSTART,          /* CR2 */
  ADC_SMPR1_SMP_AN12(ADC_SAMPLE_480) | ADC_SMPR1_SMP_AN12(ADC_SAMPLE_480) |
...
//  ADC_SQR2_SQ8_N(ADC_CHANNEL_IN11)   | ADC_SQR2_SQ7_N(ADC_CHANNEL_IN11),    //SQR2: Conversion group sequence 7...12
  ...
  ADC_SQR2_SQ8_N(ADC_CHANNEL_IN12)   | ADC_SQR2_SQ7_N(ADC_CHANNEL_IN12) ,
  ADC_SQR3_SQ6_N(ADC_CHANNEL_IN12)   | ADC_SQR3_SQ5_N(ADC_CHANNEL_IN12) |
  ADC_SQR3_SQ4_N(ADC_CHANNEL_IN12)   | ADC_SQR3_SQ3_N(ADC_CHANNEL_IN12) |
  ADC_SQR3_SQ2_N(ADC_CHANNEL_IN12)   | ADC_SQR3_SQ1_N(ADC_CHANNEL_IN12)     //SQR3: Conversion group sequence 1...6
};
...
void myADCinit(void){
  palSetGroupMode(GPIOC, PAL_PORT_BIT(2),
