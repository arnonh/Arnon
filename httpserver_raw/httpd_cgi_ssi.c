...
///* we will use character "t" as tag for SSI */
//char const* TAGCHAR="u";
//char const* TAGCHAR2="t";
//char const** TAGS= { &TAGCHAR, &TAGCHAR2 };

const char * tags_support[] = {"t" , "u"};
const int number_of_tags = 2;
...
//    int var1 = 1234;
//    *pcInsert='\0';
//    sprintf((char*)&pcInsert[strlen(pcInsert)], "var=%d",var1);
...
void httpd_ssi_init(void)
{
  ...
  http_set_ssi_handler(ADC_Handler, tags_support, number_of_tags);
}
